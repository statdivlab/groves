...
In this vignette, we will investigate $63$ estimated gene trees and $2$ estimated phylogenomic trees for a set of $73$ Prevotella genomes. This dataset was generated using the Genome Taxonomy Database (GTDB), release 202 (Parks et al. 2018) (Parks et al. 2020). More details about this data can be found in [add citation to pre-print!].
...
```{r}
head(plot_res$pc1_info)
head(plot_res$pc2_info)
```
